...
This example adds a new environment behaviour to the configuration to better
illustrate the benefit of families: ``GET_NEARBY`` allows the get_observations
script to try getting observations from a nearby site if the specified
site has not reported an observation.
